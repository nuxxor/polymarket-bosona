...
def main():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        assert budget['end_ms'] is None and read_budget(root/'BUDGET_G.json', allow_unlimited=True) == budget
    ...
    with tempfile.TemporaryDirectory() as td:
        root = Path(td)
        protocol = {'minutes': None, 'loss_limit': 10, 'clip': 5, 'continuous': True}
    ...
    print('G GECTI: salt-okunur SDK, varsayilan emir yok, hash, tek kullanim, sinirsiz sure/$10, eski muhasebe.')
