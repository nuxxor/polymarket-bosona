...
def audit():
    ...
    report = dict(matched_transactions=len(matched), requested_transactions=len(wanted), missing=dict(missing),
                  ...
                  five_share_actor_price=summary(result, 'five_share_actor_price_pnl'),
                  five_share_prior_ask=summary(result, 'five_share_quoted_ask_pnl'),
...
if __name__ == '__main__':
    ...
    parser.add_argument('action', choices=['fetch', 'check', 'analyze', 'audit', 'watch'])
