...
- [ ] 1. Gerçek maker parçaları/parent kimlikleri ve 1/5/10sn markout tablosu.
- [ ] 2. Sonuçtan bağımsız kontrol eşleştirmesi, kapsam/tekrar/kayıp/karşı örnekler.
- [ ] 3. İki önbilgi hipotezi, dolumdan bağımsız seçici, açık yanlışlama sonucu.
- [ ] Kimlik/rol/fiyat, as-of/gelecek değişimi, ufuk sansürü, match bağımsızlığı
      ve küme ağırlığı regresyonu; Ruff/syntax, gerçek ağsız çalışma ve aynı hash.
- [ ] Kaynakların korunduğu doğrulansın; kısa Türkçe rapor ve tekrar komutu.
